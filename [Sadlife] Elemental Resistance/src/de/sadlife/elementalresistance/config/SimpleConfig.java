package de.sadlife.elementalresistance.config;
...
public class SimpleConfig extends YamlConfiguration {
	...
	private File extract(String path) {
		final JavaPlugin i = ElementalResistance.getInstance();
	...
	private File createFileAndDirectory(String path) {
		...
		final File datafolder = ElementalResistance.getInstance().getDataFolder();
